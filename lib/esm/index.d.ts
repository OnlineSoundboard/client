import { Client, type KeyValueObject, type SocketClient, type DefaultBoardData, type Board, type BoardOptions } from './client.js';
...
export interface ClientToServerEvents<ClientData extends KeyValueObject = {}, BoardData = DefaultBoardData, SoundData = DefaultSoundData> {
    'board:create': (args: {
        ...
        auth?: string | null;
        locked?: boolean;
    }, callback: (err: OSBErrorSerialized | null, board: Board) => void) => void;
    'board:join': (args: {
        clientData: ClientData;
        boardId: string;
        auth?: string;
    ...
    'board:update': (args: {
        options: BoardOptions<BoardData>;
    }, callback: (err: OSBErrorSerialized | null, board: Board<BoardData>) => void) => void;
    'board:client:update': (args: {
        clientData: ClientData;
    }, callback: (err: OSBErrorSerialized | null, clientData: ClientData) => void) => void;
    'sound:play': (args: {
        soundId: string;
    }) => void;
    'sound:missing': (args: {
        soundId: string;
    }, callback: (err: OSBErrorSerialized | null, sound: Sound<SoundData>) => void) => void;
    'sound:update': (args: {
        sound: Sound<SoundData>;
    }, callback: (err: OSBErrorSerialized | null) => void) => void;
    'sound:delete': (args: {
        soundId: string;
    }, callback: (err: OSBErrorSerialized | null) => void) => void;
...
export interface ServerToClientEvents<ClientData extends KeyValueObject = {}, BoardData = DefaultBoardData, SoundData = DefaultSoundData> {
    ...
    'board:joined': (args: {
        client: SocketClient<ClientData>;
    }) => void;
    'board:left': (args: {
        client: SocketClient<ClientData>;
    }) => void;
...
declare const _default: {
    ...
    SoundCache: typeof SoundCache;
    OSBError: typeof OSBError;
};
